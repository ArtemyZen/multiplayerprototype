...
namespace Photon.Realtime
{
    ...
    #endif
    {
        ...
        private void LogBasics()
        {
            ...
            sb.AppendFormat("AppID: \"{0}\" AppVersion: \"{1}\" Client: v{2} ({4}) Build: {3} ", appIdShort, this.client.AppVersion, Photon.Client.PhotonPeer.Version, string.Join(", ", buildProperties.ToArray()), this.client.LoadBalancingPeer.TargetFramework);
            ...
            sb.AppendFormat("UserId: \"{0}\" AuthType: {1} AuthMode: {2} {3} ", this.client.UserId, (this.client.AuthValues != null) ? this.client.AuthValues.AuthType.ToString() : "N/A", "N/A", this.client.EncryptionMode);
        ...
        {
			Debug.Log(this.GetFormattedTimestamp() + " SupportLogger OnCustomAuthenticationResponse(" + Photon.Client.SupportClass.DictionaryToString(data)+").");
        }
