...
#if PHOTON_LEGACY_REALTIME_CLIENT
// </copyright>
// <summary>
...
namespace Photon.Realtime
{
    ...
    public class LoadBalancingPeer : PhotonPeer
    {
        ...
        private void ConfigUnitySockets()
        {
            ...
            if (websocketType == null)
            {
                websocketType = Type.GetType("ExitGames.Client.Photon.SocketNativeSource, Photon.Realtime", false);
            }
            if (websocketType != null)
            {
    ...
    #if PHOTON_LEGACY_REALTIME_DUPLICATES
