...
namespace Photon.Voice.Unity.UtilityScripts
{
    ...
    public class PhotonVoiceStatsGui : MonoBehaviour
    {
        ...
        private void TrafficStatsWindow(int windowId)
        {
            ...
            long elapsedMs = Mathf.Max(1, Time.frameCount > 0 ? Mathf.RoundToInt(Time.realtimeSinceStartup) : 1);
            ...
            string total = this.peer.VitalStatsToString(false);
            ...
            if (this.trafficStatsOn)
            {
                ...
                trafficStatsIn = string.Empty;
                trafficStatsOut = this.peer.VitalStatsToString(false);
